        ...
        <div className='container' >
            <div className='containeruserbar'>
                ...
                <div className='container_imgcalendario'>
                    <h1 onClick={navigatemeuslembretes} className='h1_userbar'>TO-DO-LIST {<img className='style_imgcalendario' src={ImagemCalendario} alt="" />}</h1>
                </div>
                    ...
                    <div className='containeropenseta'>
                        ...
                        {ListaVisivel && (
                            ...
                            <div className='containerlistaordenada'>
                                ...
                                <ul className='listasstyle'>
                                    <li>
                                        <a onClick={navigatemeuslembretes}>Meus Lembretes</a>
                                    </li>
                                </ul>
                            </div>
                        )}
